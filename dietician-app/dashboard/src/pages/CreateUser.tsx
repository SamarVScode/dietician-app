...
export default function CreateUser() {
      ...
      >
        <div
          style={{
            ...
            padding: '40px',
            width: '440px',
            boxShadow: '0 24px 80px rgba(13,27,62,0.2)',
          }}
        >
          {/* Success Icon */}
          ...
          <div style={{ display: 'flex', gap: '10px' }}>
            <button
              ...
              style={{
                ...
                padding: '13px',
                borderRadius: '14px',
                background: copied ? '#f0fdf4' : '#eef3ff',
                border: copied ? '1px solid #bbf7d0' : '1px solid #dbe8ff',
                color: copied ? '#15803d' : '#1a73e8',
                fontSize: '14px',
                fontWeight: '700',
                cursor: 'pointer',
                display: 'flex',
  ...
  const inputStyle = (hasError: boolean, focused: boolean = false) => ({
    width: '100%',
    padding: '13px 16px',
    borderRadius: '14px',
    border: hasError
      ...
      ? '2px solid #1a73e8'
      : '2px solid #e8eef8',
    background: hasError ? '#fff5f5' : focused ? '#fafcff' : '#f8fafd',
    fontSize: '14px',
    fontWeight: '500',
    color: '#0d1b3e',
    outline: 'none',
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '20px' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                  <div
                    style={{
                      ...
                      fontSize: '13px',
                      fontWeight: '700',
                      color: i <= activeStep ? 'white' : '#b0bdd8',
                ...
                {i < steps.length - 1 && (
                  <div
                    style={{
                      flex: 1,
                      height: '2px',
                      background: i < activeStep ? '#1a73e8' : '#e8eef8',
                      margin: '0 12px',
        ...
        <div style={sectionStyle}>
          <div style={sectionHeaderStyle}>
            <div style={sectionIconStyle('#eef3ff')}>
              <User size={20} color="#1a73e8" />
            </div>
            <div>
              <div style={{ fontSize: '16px', fontWeight: '700', color: '#0d1b3e' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
            ...
            <div style={{ gridColumn: '1 / -1' }}>
              ...
              <input
                ...
                onBlur={(e) => {
                  e.target.style.border = errors.name ? '2px solid #fc8181' : '2px solid #e8eef8'
                  e.target.style.background = errors.name ? '#fff5f5' : '#f8fafd'
                }}
              />
            ...
            <div>
              ...
              <input
                ...
                onBlur={(e) => {
                  e.target.style.border = errors.age ? '2px solid #fc8181' : '2px solid #e8eef8'
                  e.target.style.background = errors.age ? '#fff5f5' : '#f8fafd'
                }}
              />
            ...
            <div>
              ...
              <input
                ...
                onBlur={(e) => {
                  e.target.style.border = '2px solid #e8eef8'
        ...
        <div style={sectionStyle}>
          <div style={sectionHeaderStyle}>
            <div style={sectionIconStyle('#f0fdfa')}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
            ...
            <div>
              <label style={labelStyle}>
                <Weight size={13} style={{ display: 'inline', marginRight: '4px' }} />
                Weight (kg) *
              </label>
              <input
                type="number"
                ...
                onBlur={(e) => {
                  e.target.style.border = errors.weight ? '2px solid #fc8181' : '2px solid #e8eef8'
                  e.target.style.background = errors.weight ? '#fff5f5' : '#f8fafd'
                }}
              />
            ...
            <div>
              <label style={labelStyle}>
                <Ruler size={13} style={{ display: 'inline', marginRight: '4px' }} />
                Height (cm) *
              </label>
              <input
                type="number"
                ...
                onBlur={(e) => {
                  e.target.style.border = errors.height ? '2px solid #fc8181' : '2px solid #e8eef8'
                  e.target.style.background = errors.height ? '#fff5f5' : '#f8fafd'
                }}
              />
          ...
          {bmiData && (
            ...
            >
              <div>
                <div style={{ fontSize: '12px', fontWeight: '600', color: '#8a9bc4', marginBottom: '2px' }}>
                  BMI (Auto Calculated)
                </div>
                <div style={{ fontSize: '28px', fontWeight: '800', color: '#1a73e8', letterSpacing: '-0.5px' }}>
                  {bmiData.value}
                </div>
              </div>
              <div
            ...
            <div style={{ display: 'flex', gap: '10px' }}>
              {BODY_TYPES.map((bt) => (
                <button
                  ...
                  style={chipStyle(form.bodyType === bt)}
                >
                  {bt}
                </button>
              ))}
        ...
        <div style={sectionStyle}>
          <div style={sectionHeaderStyle}>
            <div style={sectionIconStyle('#fefce8')}>
          ...
          <div style={{ marginBottom: '20px' }}>
            <label style={labelStyle}>
              <Target size={13} style={{ display: 'inline', marginRight: '4px' }} />
              Goal *
            </label>
            <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' as const }}>
              {GOALS.map((g) => (
            ...
            <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' as const }}>
              {PREFERENCES.map((p) => (
                <button
                  key={p}
                  type="button"
                  onClick={() => updateField('preference', p)}
                  style={chipStyle(form.preference === p)}
                >
                  {p}
                </button>
              ))}
            ...
            <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' as const }}>
              {ALLERGY_OPTIONS.map((a) => (
                <button
                  ...
                  style={{
                    ...chipStyle(form.allergies.includes(a)),
        ...
        <div style={sectionStyle}>
          <div style={sectionHeaderStyle}>
            <div style={sectionIconStyle('#fff5f5')}>
          ...
          <div style={{ marginBottom: '20px' }}>
            <label style={labelStyle}>
              <Heart size={13} style={{ display: 'inline', marginRight: '4px' }} />
              Medical Conditions
            </label>
            <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' as const }}>
              {CONDITIONS.map((c) => (
                <button
                  ...
                  style={chipStyle(form.conditions.includes(c))}
                >
                  {c}
                </button>
              ))}
          ...
          <div style={{ marginBottom: '16px' }}>
            <label style={labelStyle}>
              <Pill size={13} style={{ display: 'inline', marginRight: '4px' }} />
              Current Medications
            </label>
            <input
              type="text"
        ...
        >
          <button
            ...
            onMouseEnter={(e) => {
              ...
              e.currentTarget.style.borderColor = '#dbe8ff'
            }}
            onMouseLeave={(e) => {
