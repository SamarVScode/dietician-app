      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
        ...
        <div className="grid grid-cols-1 gap-2 sm:grid-cols-2 sm:gap-4 lg:grid-cols-3">
          {[
            ...
            >
              <div
                className="mb-0 shrink-0 sm:flex sm:items-center sm:justify-between sm:mb-4"
              >
                <div
              ...
              <div className="flex flex-col min-w-0 flex-1">
                ...
                <div
                  className="text-[11px] font-semibold mb-0 sm:text-[13px] sm:mb-2"
                  style={{
                    color: '#4a5568',
                  }}
                >
        ...
        {/* Table */}
        <div className="overflow-x-auto [-webkit-overflow-scrolling:touch] rounded-[20px] shadow-[0_2px_16px_rgba(26,115,232,0.06)]">
        <div
        ...
        >
          ...
          {!isLoading && filtered.length === 0 && (
            <div
              className="px-5 py-10 sm:px-10 sm:py-20"
              style={{
                display: 'flex',
                flexDirection: 'column',
                alignItems: 'center',
