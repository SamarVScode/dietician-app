...
/* ─── Nutrition tile (matches homePage.html .nut-stat) ── */
...
function NutritionTiles({ calories, protein, carbs, fats }: {
...
const styles = StyleSheet.create({
  ...
  /* Nutrition tiles — matches homePage.html .nut-card/.nut-stat */
  nutRow: {
    flexDirection: 'row',
    gap: 8,
    padding: 14,
  ...
  goalEyebrowText:  { fontSize: 10, fontWeight: '700', letterSpacing: 2.2, textTransform: 'uppercase', color: '#5db8d8' },
