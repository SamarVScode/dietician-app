    ...
    <TouchableOpacity onPress={onPress} onPressIn={pressIn} onPressOut={pressOut} activeOpacity={1}>
      <RNAnimated.View style={{ transform: [{ scale }] }}>
        <View style={[styles.filterPillClip, active && styles.filterPillClipActive]}>
          <BlurView intensity={active ? 25 : 20} tint="light" style={StyleSheet.absoluteFill} />
    ...
    <TouchableOpacity style={styles.dateItem} onPress={onPress} onPressIn={pressIn} onPressOut={pressOut} activeOpacity={1}>
      <RNAnimated.View style={{ alignItems: 'center', transform: [{ scale }] }}>
        ...
        <View style={[styles.dateBubbleClip, selected && styles.dateBubbleClipActive]}>
          <BlurView intensity={selected ? 25 : 20} tint="light" style={StyleSheet.absoluteFill} />
...
const styles = StyleSheet.create({
  ...
  filterPillOverlay:         { ...StyleSheet.absoluteFillObject, backgroundColor: 'rgba(255,255,255,0.1)' },
  filterPillOverlayActive:   { backgroundColor: 'rgba(255,255,255,0.55)' },
  ...
  dateBubbleOverlay:       { ...StyleSheet.absoluteFillObject, backgroundColor: 'rgba(255,255,255,0.1)' },
  dateBubbleOverlayActive: { backgroundColor: 'rgba(255,255,255,0.55)' },
  ...
  emptyIconOverlay: { ...StyleSheet.absoluteFillObject, backgroundColor: 'rgba(255,255,255,0.15)' },
