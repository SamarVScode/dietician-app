    ...
    <TouchableOpacity onPress={onPress} onPressIn={pressIn} onPressOut={pressOut} activeOpacity={1} style={styles.outer}>
      <Animated.View style={{ transform: [{ scale }] }}>
        <View style={[styles.clip, active ? styles.clipActive : styles.clipInactive]}>
          <BlurView
            intensity={active ? 95 : 85}
            tint="light"
            style={[StyleSheet.absoluteFill, { borderRadius: radius.activePill }]}
          />
          <View style={[styles.overlay, active ? styles.overlayActive : styles.overlayInactive, { borderRadius: radius.activePill }]} />
