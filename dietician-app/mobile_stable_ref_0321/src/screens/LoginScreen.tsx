    ...
    <AppBackground>
      ...
      >
        ...
        <Animated.View style={[styles.appIcon, { transform: [{ scale: iconScale }] }]}>
          ...
          <View style={[styles.appIconOverlay, { borderRadius: 24 }]} />
      ...
      <KeyboardAvoidingView style={styles.kavWrapper} behavior="padding">
        ...
        >
          <BlurView intensity={70} tint="light" style={[StyleSheet.absoluteFill, { borderRadius: 32 }]} />
          <View style={[styles.sheetOverlay, { borderRadius: 32 }]} />
...
const styles = StyleSheet.create({
  ...
  appIcon: {
    ...
    overflow: 'hidden',
    borderWidth: 1.5,
    borderColor: 'rgba(0,201,184,0.25)',
    shadowColor: colors.primary,
  ...
  sheet: {
    ...
    borderWidth: 1,
    borderColor: 'rgba(0,201,184,0.15)',
    borderBottomWidth: 0,
    overflow: 'hidden',
  },
  ...
  handle: {
    ...
    height: 4,
    borderRadius: 2,
    backgroundColor: 'rgba(0,201,184,0.25)',
    alignSelf: 'center',
    marginBottom: 28,
  },
