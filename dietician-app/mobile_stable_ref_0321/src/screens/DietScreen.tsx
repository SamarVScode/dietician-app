...
const styles = StyleSheet.create({
  ...
  kcalChip: { backgroundColor: 'rgba(136,255,239,0.08)', borderRadius: radius.kcalBadge, paddingHorizontal: 10, paddingVertical: 4, borderWidth: 1, borderColor: 'rgba(136,255,239,0.12)' },
