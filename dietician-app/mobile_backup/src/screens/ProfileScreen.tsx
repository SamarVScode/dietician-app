              ...
              <View style={styles.identityInner}>
                ...
                <View style={styles.avatarRingOuter}>
                  <View style={styles.avatarInner}>
                    <BlurView intensity={20} tint="light" style={[StyleSheet.absoluteFill, { borderRadius: 40 }]} />
                    <View style={[styles.avatarOverlay, { borderRadius: 40 }]} />
                ...
                <View style={styles.statusPill}>
                    <BlurView intensity={85} tint="light" style={[StyleSheet.absoluteFill, { borderRadius: 999 }]} />
                    <View style={[styles.statusOverlay, { borderRadius: 999 }]} />
...
const styles = StyleSheet.create({
  ...
  avatarOverlay: { ...StyleSheet.absoluteFillObject, backgroundColor: 'rgba(91, 76, 245, 0.45)' }, // semi-transparent accentIndigo
  ...
  statusOverlay: { ...StyleSheet.absoluteFillObject, backgroundColor: 'rgba(255,255,255,0.45)' },
