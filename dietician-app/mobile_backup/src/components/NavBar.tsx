    ...
    >
      <View style={styles.pillBorder}>
        <View style={styles.pillClip}>
          ...
          >
            <BlurView intensity={95} tint="light" style={[StyleSheet.absoluteFill, { borderRadius: radius.activePill }]} />
            <View style={[styles.activePillOverlay, { borderRadius: radius.activePill }]} />
            {/* Top Border Layer */}
            <View style={styles.activePillBorderLayer} pointerEvents="none" />
          </Animated.View>
...
const styles = StyleSheet.create({
  ...
  shadow: {
    // SHADOW REMOVED: avoiding box artifact
  },
  pillBorder: {
    width: NAV_W,
    height: 66,
  ...
  overlay: {
    // OVERLAY REMOVED: using Pure Blur
  },
